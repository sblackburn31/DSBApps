...
/// <summary>
/// This is the primary controller for the notebook application.
/// </summary>
using System;
...
{
    public class NotebookAppController : Controller
    {
        /// <summary>
        ...
        /// </summary>
        private NotebookDataRepository dataRepository = null;

        /// <summary>
        /// This is how the datarepository is injected into the controller object.
        /// </summary>
        public NotebookAppController()
            : this(new NotebookDataRepository())
        {
        }
        ...
        /// This is how the datarepository is injected into the controller object.
        /// </summary>
        public NotebookAppController(NotebookDataRepository dr)
        {
        ...
        /// </summary>
        /// <returns>Returns an Action result, that is a view if the Index screen or a redirection to the NoteList Action</returns>
        [AllowAnonymous]
        ...
        /// <summary>
        /// NoteList - this page shows the notes belonging to the user's notebook. 
        ...
        /// From the NoteList page the user may edit, delete or view one of the previous notes or create a new one.
        ...
        /// </summary>
        /// <returns>
        /// The NoteList view is viewed, unless the user exited a note they were editing in the prevoius session, in that case the note is brought up
        ...
        public ActionResult NoteList()
        {
            ...
            if (aNotebook == null)
            {
                ...
                return View("NoteList", aNotebook);
            }
            else
            {
        ...
        /// </summary>
        /// <returns>Always reditects to the NoteList</returns>
        ...
        /// NoteList redirection
        /// Create Note's successful save Post
        /// Selected as a list item from the NoteList
        ...
        /// <summary>
        /// Details
        /// This action is reached by selection as a list item from the NoteList
        ...
        /// <summary>
        /// Create
        /// This action is reached by the CREATE NOTE button from the NoteList screen
        ...
        /// <returns>this always redirects to the NoteList screen</returns>
        // POST: Notes/Delete/5
