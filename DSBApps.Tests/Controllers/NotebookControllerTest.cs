...
using Moq;
using NotebookMVCApp;
using DSBApps.Controllers;
using DSBApps.Models;
using NotebookMVCApp.Tests.Models;

namespace DSBApps.Controllers
{
    [TestClass]
    public class NotebookAppControllerTest
    {
        #region Test Setup
        ...
        NotebookDataRepository dataRepo = null;
        NotebookAppController controller = null;

        public NotebookAppControllerTest()
        {
            ...
            dataRepo = new NotebookDataRepository(notebooksRepo, noteRepo);

            // Now lets create the BooksController object to test and pass our unit of work
            controller = new NotebookAppController(dataRepo);
        ...
        public void About()
        {
            ...
            Assert.AreEqual("The application description page.", result.ViewBag.Message);
        }
        ...
        public void IndexIsAuthenticated()
        {
            ...
            // Assert
            Assert.AreEqual("NoteList", result.RouteValues["action"].ToString());
        }
        [TestMethod]
        ...
        public void NotebookNewUserNewNotebook()
        {
            ...
            // Assert
            ViewResult result = controller.NoteList() as ViewResult;

            // Assert
            Assert.AreEqual("NoteList", result.ViewName);
        ...
        public void NotebookNotebookCurrentNote()
        {
            ...
            // Action
            RedirectToRouteResult result = (RedirectToRouteResult)controller.NoteList();
